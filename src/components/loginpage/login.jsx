        ...
        <div className="bg-white rounded-2xl shadow-2xl shadow-slate-200/50 p-8 sm:p-10 border border-slate-100">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button 
              ...
              type="button"
              className="flex items-center justify-center px-4 py-2.5 border border-slate-200 rounded-xl text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors"
            >
